...
var hap_settings = {
	...
	buttonsUrl: {prev: '{{res}}media/data/icons/set1/prev.png', prevOn: '{{res}}media/data/icons/set1/prev_on.png', 
				 next: '{{res}}media/data/icons/set1/next.png', nextOn: '{{res}}media/data/icons/set1/next_on.png', 
				 pause: '{{res}}media/data/icons/set1/pause.png', pauseOn: '{{res}}media/data/icons/set1/pause_on.png',
				 play: '{{res}}media/data/icons/set1/play.png', playOn: '{{res}}media/data/icons/set1/play_on.png',
				 volume: '{{res}}media/data/icons/set1/volume.png', volumeOn: '{{res}}media/data/icons/set1/volume_on.png', 
				 mute: '{{res}}media/data/icons/set1/mute.png', muteOn: '{{res}}media/data/icons/set1/mute_on.png', 
				 download: '{{res}}media/data/icons/set1/download.png', downloadOn: '{{res}}media/data/icons/set1/download_on.png',
				 loop: '{{res}}media/data/icons/set1/loop.png', loopOn: '{{res}}media/data/icons/set1/loop_on.png',
				 shuffle: '{{res}}media/data/icons/set1/shuffle.png', shuffleOn: '{{res}}media/data/icons/set1/shuffle_on.png',
				 trackUrlIcon: '{{res}}media/data/url.png',
				 trackDownloadIcon: '{{res}}media/data/dlink.png',
				 trackRemoveIcon: '{{res}}media/data/remove.png',
				 link_play: '{{res}}media/data/link_play.png', link_pause: '{{res}}media/data/link_pause.png'},
